...
<head>
    ...
    <meta name="author" content="SoBro Creative"/>
...
<section class="parallex_wrapper para_container event-banner">
    ...
    <div class="parallex_folio design_bg7">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 col_center">
                ...
                <p>Do you know what an Innovate Today event is? If not, click
                    <a href="../index.php#sec-about">here</a>
                    to find out! </p>
                ...
                <p><i>
                    *The student must be attending a school at the university, college, or high school level. To insure the participant is a student. All participants must bring a valid Student ID to the event.
                </i></p>
...
<section class="parallex_wrapper para_container" id="sec-sponsers">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col_center">
                                ...
                                <div class="hgroup_2 align_center light_font">
                                    <h2>Our Sponsors</h2>
                                    <h3>This event wouldn't be possible without these sponsors, thank you!</h3>
                                </div>
                                <!-- hgroup_2 Mod ends -->
                            </div>
                            <!-- child_col ends -->
